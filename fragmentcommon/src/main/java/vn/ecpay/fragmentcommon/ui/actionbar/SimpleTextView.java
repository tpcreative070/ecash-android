...
public class SimpleTextView extends View implements Drawable.Callback {
    ...
    private int drawablePadding = Utilities.dp(4);
    ...
    private boolean createLayout(int width) {
        if (text != null) {
            try {
                ...
                layout = new StaticLayout(string, 0, string.length(), textPaint, width + Utilities.dp(8), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
