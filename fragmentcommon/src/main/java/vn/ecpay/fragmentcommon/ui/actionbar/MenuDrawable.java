...
public class MenuDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawLine(-Utilities.dp(9), 0, Utilities.dp(9) - Utilities.dp(3.0f) * currentRotation, 0, paint);
        float endYDiff = Utilities.dp(5) * (1 - Math.abs(currentRotation)) - Utilities.dp(0.5f) * Math.abs(currentRotation);
        float endXDiff = Utilities.dp(9) - Utilities.dp(2.5f) * Math.abs(currentRotation);
        float startYDiff = Utilities.dp(5) + Utilities.dp(2.0f) * Math.abs(currentRotation);
        float startXDiff = -Utilities.dp(9) + Utilities.dp(7.5f) * Math.abs(currentRotation);
