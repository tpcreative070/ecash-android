package vn.ecpay.fragmentcommon.ui.slidetounlock;
...
public class TranslateRenderer implements IRenderer {
    ...
    public void renderChanges(ISlidingData slidingData, View child, float percentage, Point transformed) {
        ...
        if (translateX + child.getWidth() >= slidingData.getParentDimen().width) {
            translateX = slidingData.getParentDimen().width - child.getWidth();
        }
