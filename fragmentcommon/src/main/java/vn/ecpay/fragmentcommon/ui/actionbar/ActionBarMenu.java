...
public class ActionBarMenu extends LinearLayout {
    ...
    public View addItemView(int id, View view) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            view.setBackground(Theme.createBarSelectorDrawable(parentActionBar.itemsBackgroundColor));
        } else {
    ...
    public ActionBarMenuItem addItem(int id, Drawable drawable) {
        return addItem(id, 0, parentActionBar.itemsBackgroundColor, drawable, Utilities.dp(48));
    }
    ...
    public ActionBarMenuItem addItem(int id, int icon, int backgroundColor) {
        return addItem(id, icon, backgroundColor, null, Utilities.dp(48));
    }
