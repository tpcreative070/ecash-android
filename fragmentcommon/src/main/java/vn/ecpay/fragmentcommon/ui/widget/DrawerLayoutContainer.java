...
import vn.ecpay.fragmentcommon.util.BuildVars;
...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    public DrawerLayoutContainer(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            setOnApplyWindowInsetsListener((v, insets) -> {
                ...
                Utilities.statusBarHeight = insets.getSystemWindowInsetTop();
                lastInsets = insets;
    ...
    public void openDrawer(boolean fast) {
        ...
        if (Utilities.isTablet() && getRootView() != null && getRootView().findFocus() != null) {
            Utilities.hideKeyboard(getRootView().findFocus());
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            inLayout = true;
            if (heightSize == Utilities.displaySize.y + Utilities.statusBarHeight) {
                if (getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
                    setPadding(0, Utilities.statusBarHeight, 0, 0);
                }
                heightSize = Utilities.displaySize.y;
            } else {
                if (getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
                    setPadding(0, 0, 0, 0);
                }
