...
//
//@Database(entities = {CashLogs.class}, version = 1, exportSchema = false)
...
//    }
//
//    public static void insertTask(CashLogs cash, String userName) {
...
//    }
//
//    private static void insertTask(final CashLogs cash) {
