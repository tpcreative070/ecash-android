...
package vn.ecpay.ewallet.model.changePass.response;
...
public class ResponseData {
    ...
    @SerializedName("requirePassChange")
    private String mRequirePassChange;
    ...
    public String getRequirePassChange() {
        return mRequirePassChange;
    }

    public void setRequirePassChange(String requirePassChange) {
        mRequirePassChange = requirePassChange;
    }
